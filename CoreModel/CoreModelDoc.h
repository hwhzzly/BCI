...
protected:
	...
	double              m_nMeanValue;                   //for RemoveMeanData
	double				m_nMeanLValue;					//for RemoveMeanData2
	double				m_nMeanRValue;					//for RemoveMeanData2
