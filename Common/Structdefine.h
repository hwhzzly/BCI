...
//0.5秒的咬牙数据
#define BITELENGTH 0.45
#define ONEBITELENGTH 0.30
#define SMALLTIME  0.08
...
/*去除50HZ工频信号*/
static double a_50[] = {1.0000,-1.3360,2.4115,-1.3130,0.9659};
static double b_50[] = {0.9828,-1.3245,2.4118,-1.3245,0.9828};
/*3Hz highpass*/
static double a_3[] = {1.0000,-4.5236,8.2058,-7.4602,3.3986,-0.6206};
static double b_3[] = {0.7878,-3.9389,7.8778,-7.8778,3.9389,-0.7878};
